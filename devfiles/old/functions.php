...
//adding stylesheets
function diy_add_styles_and_scripts() 
{
	//styles
	$url = get_stylesheet_directory_uri() .'/css/vendor.min.css';
	wp_enqueue_style('diy-vendor', $url,array(),null);
	
	wp_enqueue_style('default-style', get_stylesheet_uri(),array('diy-vendor'),null);
	
	$url = get_stylesheet_directory_uri() .'/css/custom.min.css';
	wp_enqueue_style('diy-custom', $url,array('default-style'),null);
	
	//scripts s
	$url = get_template_directory_uri() .'/js/vendor.min.js';
	wp_enqueue_style('diy-vendor-js', $url, array(),null);
}
function diy_add_custom_script()
{
	$url_custom = get_template_directory_uri() .'/js/scripts.min.js';
	wp_enqueue_script('diy-custom-js', $url_custom, array( 'jquery' ), null, true);
}

add_action('wp_enqueue_scripts', 'diy_add_styles_and_scripts');
add_action('wp_enqueue_scripts', 'diy_add_custom_script');
/*-----------------------------------------------------------------------------------*/
